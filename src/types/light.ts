...
export interface LightSwUpdate {
    state: 'noupdates' | 'transferring' | 'installing' | 'readytoinstall' | 'anyreadytoinstall';
    lastinstall: string;
}
 ...
 */
export type LightStateResult = LightStateSuccessResponse | { error: { type: number; address: string; description: string } };
