...
function createService(devices, stateValues = {}) {
    const adapter = (0, testHelpers_1.createMockDeviceBindingAdapter)(stateValues);
    const logger = (0, testHelpers_1.createMockLogger)();
...
//# sourceMappingURL=testDeviceBinding.js.map